...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //holder.statusView.setChecked(toDoItem.getStatus().toString()
        //        .equals(ToDoItem.Status.DONE)?true:false);
        ...
        String prior_text = toDoItem.getPriority().toString();

        holder.priorityView.setText(prior_text);
