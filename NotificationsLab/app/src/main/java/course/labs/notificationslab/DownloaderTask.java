				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != MainActivity.IS_ALIVE) {
                            ...
                            PendingIntent restartMainActivityIntent = PendingIntent
                                    .getActivity(mApplicationContext, 0, restartMainActivtyIntent,
                            ...
                            Notification.Builder notificationBuilder = new Notification.Builder(mApplicationContext)
                                    ...
                                    .setContentIntent(restartMainActivityIntent)
